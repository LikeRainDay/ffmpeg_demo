...
int test_rtmp_pusher::doPush() {
    char *inUrl = "/Users/houshuai/CLionProjects/demo_ffmpeg/files/test_01.flv";
    char *outUrl = "rtmp://localhost:32768/live";
    ...
    printf("open file %s  Sucess!", inUrl);
    ...
    printf("outFormatCtx Create Success! ");
...
//        cout << pkt.pts << "   " << flush;
        ...
        pkt.duration = av_rescale_q_rnd(pkt.duration, inTime, outTime,
